...
$params = array("Test3", "Ans3", "Test4", "Ans4", "Test5", "Ans5");
...
if ($conn->connect_error) {
  ...
  $sql = "INSERT INTO `questions` (`Difficulty`, `Topic`, `Name`, `Parameters`, `ReturnValue`, `Test1`, `Ans1`, `Test2`, `Ans2`, `Test3`, `Ans3`, `Test4`, `Ans4`, `Test5`, `Ans5`) VALUES ('".$_POST["Difficulty"]."',
  ...
  NULLIF('".$_POST["Ans3"]."', 'NULL'), NULLIF('".$_POST["Test4"]."','NULL'), NULLIF('".$_POST["Ans4"]."', 'NULL'), NULLIF('".$_POST["Test5"]."', 'NULL'), NULLIF('".$_POST["Ans5"]."', 'NULL'));";
